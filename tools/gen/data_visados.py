...
VISADOS = {
    ...
    "guinea-bisau": visa(
        "presencial", "Visado previo para pasaporte español.",
        "Obtenerlo en la Embajada de Guinea-Bisáu en Madrid.", entradas="si se reactiva la alternativa", ruta="excluido",
        alerta="La solicitud electrónica figura paralizada y la expedición en frontera no es clara ni estable.",
        maec=_maec("Guinea Bisáu")),
    "sierra-leona": visa(
    ...
    "sudan": visa(
        "no_viable", "Visado presencial obligatorio, pero las fronteras terrestres están cerradas a extranjeros.",
        "Excluir del viaje mientras continúen la guerra y el cierre fronterizo.", ruta="excluido",
        alerta="MAEC desaconseja viajar bajo cualquier circunstancia; solo funciona el aeropuerto civil de Port Sudán.",
        maec=_maec("Sudán")),
    "egipto": visa(
    ...
    "madagascar": visa(
        "frontera", "Visado disponible a la llegada en aeropuertos internacionales.",
        "Obtenerlo al aterrizar o tramitar el eVisa si se prefiere llevarlo resuelto.", ruta="vuelo",
