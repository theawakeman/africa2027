...
CPD = {
    ...
    "comoras": ("no", "SIN CONFIRMAR", "Admisión temporal aduanera (arts. 239-245 del Código de Aduanas de 2024), con despacho negociado caso por caso", "Por confirmar; el gasto real es el flete marítimo, de miles de euros por vehículo y trayecto",
              "carnetdepassage.org (AIT/FIA) indica que Comoras NO cuenta con ninguna organización autorizada para emitir CPD y remite a tramitarlo en países vecinos. El Código de Aduanas comorense de 2024 regula la admisión temporal en sus artículos 239 a 245, con exoneración total o parcial de derechos para mercancías reexportadas sin modificación, pero no menciona el carnet de passages ni el triptyque. No hemos localizado ninguna fuente aduanera que lo exija ni que lo exima expresamente. La cuestión es en buena medida teórica: sin enlace marítimo de vehículos con el continente, la entrada de un 4x4 propio pasaría por flete contratado y trámite ad hoc. Marcado SIN CONFIRMAR hasta obtener respuesta de la Direction Générale des Douanes (douane@douane.gov.km, +269 773 18 89)."),
    "seychelles": ("no", "SIN CONFIRMAR", "Admisión temporal en aduana de Port Victoria tras desembarque en contenedor; en la práctica, coche de alquiler local", "Sin dato; el flete en contenedor domina el presupuesto",
              "Carnetdepassage.org indica que Seychelles NO cuenta con organización emisora AIT/FIA propia y que un CPD para un vehículo matriculado allí debería emitirse en otro país. No se ha localizado ninguna fuente que diga que Seychelles EXIJA carnet de passages para la entrada temporal de un vehículo extranjero. La cuestión es en todo caso teórica: no hay acceso por carretera y cualquier vehículo llega en contenedor, con despacho ante la Seychelles Revenue Commission. Antes de cualquier intento real habría que confirmar el régimen de admisión temporal con la aduana seychelense y con el RACE."),
    "mauricio": ("no", "SIN CONFIRMAR", "Admisión temporal ordinaria de la Mauritius Revenue Authority con depósito de garantía", "Por confirmar",
              "La cuestión es casi teórica: no hay forma de llevar los vehículos a Mauricio sin flete marítimo, y el único puerto de entrada es Port Louis. carnetdepassage.org indica que AIT/FIA no tiene organización emisora de CPD en Mauricio, lo que se refiere a emitirlo y no a aceptarlo. La Mauritius Revenue Authority solo publica el régimen general de admisión temporal de mercancías —reexportación en seis meses, validez máxima de doce, depósito de garantía en efectivo o aval—, sin procedimiento específico para vehículo de turista ni mención alguna al carnet de passages. Hasta obtener respuesta escrita de la MRA lo damos por SIN CONFIRMAR."),
    "burundi": ("recomendable", "PROBABLE", "Admisión temporal en ventanilla de aduana en el propio paso fronterizo", "Sin dato para Burundi; el CPD se emite en España vía RACE con depósito o aval",
              "El único relato reciente que se ha podido abrir, el paso de Kobero del 5 de marzo de 2025, describe el carnet de passages sellado por las aduanas de Tanzania y de Burundi, de modo que el documento se acepta y agiliza el trámite. Ninguna fuente oficial abierta en esta sesión declara que sea obligatorio para vehículos extranjeros, y carnetdepassage.org precisa que no hay entidad emisora de CPD dentro de Burundi. Conclusión práctica: llevarlo, porque cuesta poco frente al riesgo, pero preparar también el trámite de admisión temporal en ventanilla por si lo aceptan sin carnet."),
