...
C = [
 ...
 ("congo","Congo (Brazzaville)","bajada",12,"precaución alta en fronteras y Pool · RN4 degradada","Entrada desde Camerún por Ntam; salida/entrada principal por Tchiamba-Nzassi–Massabi hacia Cabinda","Visado físico previo vía Embajada en París; cubrir dos entradas","CPD/importación temporal por confirmar en Massabi; Carte Rose solo si la póliza lo cubre","Certificado veterinario; perro prohibido en áreas de gorilas","BAJADA: Odzala → Brazzaville → Dolisie → Pointe-Noire → Massabi. SUBIDA: mismo eje sur y mesetas Batéké al norte. Ferry de Kinshasa solo secundario"),
 ("rd-congo","RD Congo (tránsito Kongo Central)","bajada",13,"MAEC desaconseja carretera · Kongo Central lejos del frente oriental pero no exento de riesgo","Principal terrestre Yema–Muanda–Boma–Matadi–Lufu; ferry de Kinshasa solo alternativo","Solicitud física en Madrid; entradas múltiples o dos visados","Documento temporal y seguro local por confirmar en Yema y Lufu","Requisitos terrestres no publicados con claridad; confirmar con Embajada","Tránsito principal corto por Kongo Central en ambos sentidos, sin Kinshasa. Validar la carretera Muanda–Yema después de lluvias"),
 ("angola","Angola","bajada",14,"precaución reforzada en Cabinda; resto según región","Massabi y Yema para Cabinda; Luvo/Lufu para Angola continental; cuatro entradas en el viaje","Exención turística para españoles: 30 días por entrada, máximo 90/año","Tasa oficial de referencia 43.236,78 AOA por entrada de turismo ligero; CPD/seguro a confirmar","Certificado veterinario + antirrábica; confirmar en cada entrada","Cabinda pasa a corredor principal solo con seguridad y seguro confirmados. El mapa separa correctamente Cabinda de Angola continental a través de RD Congo"),
