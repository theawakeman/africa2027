...
.poi-gallery { display:grid; grid-auto-flow:column; grid-auto-columns:84%; overflow-x:auto;
  scroll-snap-type:x mandatory; overscroll-behavior-inline:contain; background:#101820;
  scrollbar-width:thin; }
.poi-gallery.single { grid-auto-columns:100%; overflow:hidden; }
.poi-gallery figure { margin:0; position:relative; scroll-snap-align:start; min-width:0;
  border-right:2px solid var(--surface); }
.poi-gallery figure:last-child { border-right:0; }
.poi-gallery a { display:block; }
.poi-gallery figcaption { position:absolute; left:0; right:0; bottom:0; padding:18px 10px 7px;
  color:#fff; font:11px/1.3 "Archivo",sans-serif;
...
.poi-decision dt { color:var(--teal); font:700 11px/1.35 "Archivo",sans-serif; text-transform:uppercase; }
.poi-decision dd { margin:0; font-size:13px; line-height:1.4; color:var(--ink); }
.poi-links { font-size:12px; color:var(--ink-soft); }
