...
ADMIN_CSS = """
:root{--teal:#1E7A8A;--head:#16324F;--ink:#1c2b34;--ink-soft:#5b6b74;--surface:#fff;--surface2:#f4f7f8;--line:#e1e8ea;--red:#B43A3A;--green:#2E7D32;--amber:#C47F17}
*{box-sizing:border-box}
body{font-family:"Archivo",sans-serif;background:var(--surface2);color:var(--ink);margin:0}
.wrap{max-width:920px;margin:0 auto;padding:18px 16px 60px}
h1{font-size:22px;color:var(--head);margin:18px 0 4px}
h2{font-size:17px;color:var(--head);margin:26px 0 10px}
...
label{display:block;font-size:12.5px;font-weight:700;color:var(--ink-soft);margin:12px 0 4px}
label:first-child{margin-top:0}
input[type=text],input[type=number],input[type=url],textarea,select{width:100%;padding:9px 10px;border:1px solid var(--line);border-radius:7px;font-size:14px;font-family:inherit;background:#fff;color:var(--ink)}
textarea{min-height:70px;resize:vertical}
.row2{display:grid;grid-template-columns:1fr 1fr;gap:12px}
.btn{display:inline-block;background:var(--teal);color:#fff;border:none;border-radius:8px;padding:9px 18px;font-size:14px;font-weight:700;cursor:pointer;font-family:inherit}
...
.poi-row{display:flex;align-items:center;gap:12px;background:var(--surface);border:1px solid var(--line);border-radius:9px;padding:8px 12px}
.poi-row img{width:56px;height:56px;object-fit:cover;border-radius:6px;background:var(--surface2);flex-shrink:0}
.poi-row .meta{flex:1;min-width:0}
.poi-row .meta b{display:block;font-size:14.5px;color:var(--head)}
.poi-row .meta span{font-size:12.5px;color:var(--ink-soft)}
.poi-row .acts{display:flex;gap:6px;flex-shrink:0}
.poi-row .acts button{border:none;background:var(--surface2);border-radius:6px;padding:6px 10px;font-size:12.5px;cursor:pointer;font-family:inherit}
...
#msg.err{display:block;background:#fbe9e7;color:var(--red)}
#msg.info{display:block;background:#eef6f8;color:var(--teal)}
