...
for _slug in ["marruecos", "sahara-occidental", "guinea", "sierra-leona", "liberia", "costa-de-marfil",
              ...
              "gambia", "lesoto", "esuatini", "zimbabue", "botsuana", "zambia", "uganda", "ruanda", "yibuti", "madagascar", "tunez", "mali", "guinea-bisau", "argelia", "libia", "burkina-faso", "niger", "chad", "rca", "sudan-del-sur", "eritrea", "somalia", "guinea-ecuatorial", "cabo-verde", "santo-tome", "comoras", "seychelles", "mauricio", "burundi"]:
    try:
